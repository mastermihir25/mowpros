...
echo '<br /> <br /> <a href="'.BASE_URL.'PHPOAuthSample/index.php?connectWithIntuitOpenId">Go Back</a>';
echo '&nbsp;&nbsp;&nbsp;';
echo '<a target="_blank" href="'.BASE_URL.'PHPOAuthSample/ReadMe.htm">Read Me</a><br />';
